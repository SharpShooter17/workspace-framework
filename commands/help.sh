...
help_command() {
    ...
    echo "  cmd <command-name>       Run a command from the current workspace"
    ...
    echo "  open [workspace-name]    Open a workspace, or the current workspace if no name is provided"
